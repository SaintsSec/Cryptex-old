...
## Overview:
Cryptex is an advanced cryptography hacking tool created by a joint development between [The SAINTS][saints] and [Cosmodium CyberSecurity][ccs]. It was originally two separte tools, one reffered to as "Cryptex" and the other as "[The Codex Project](https://github.com/CosmodiumCS/the-codex-project)". But on May 2, 2022, the lead developers Cythes and Blue Cosmo joined forces to build a central cryptography tool. Since then, plenty of others have joined the project to build it into what we one day hope to be, the "Metasploit of Cryptography".
